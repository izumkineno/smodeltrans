...
fn downloadable_models() -> Vec<DownloadableModel> {
    vec![
        ...
        DownloadableModel {
            id: "hy-mt2-1.8b-2bit".to_owned(),
            name: "Hy-MT2 1.8B 2Bit".to_owned(),
            description: "超低比特极致压缩，ModelScope: Tencent-Hunyuan/Hy-MT2-1.8B-2bit-GGUF".to_owned(),
            repo_id: "Tencent-Hunyuan/Hy-MT2-1.8B-2bit-GGUF".to_owned(),
            files: vec!["Hy-MT2-1.8B-2Bit.gguf".to_owned()],
            file_specs: vec![DownloadFileSpec {
                repo_id: "Tencent-Hunyuan/Hy-MT2-1.8B-2bit-GGUF".to_owned(),
                file: "Hy-MT2-1.8B-2Bit.gguf".to_owned(),
                dest: "Hy-MT2-1.8B-2Bit.gguf".to_owned(),
            }],
            size_text: "~573 MB".to_owned(),
            kind: "translation".to_owned(),
            ocr_variant: None,
            recommended: false,
        },
        DownloadableModel {
            id: "hy-mt2-1.8b-1.25bit".to_owned(),
            name: "Hy-MT2 1.8B 1.25Bit".to_owned(),
            description: "1.25bit 极致量化仅 440MB，推理提速 1.5x，ModelScope: Tencent-Hunyuan/Hy-MT2-1.8B-1.25bit-GGUF".to_owned(),
            repo_id: "Tencent-Hunyuan/Hy-MT2-1.8B-1.25bit-GGUF".to_owned(),
            files: vec!["Hy-MT2-1.8B-1.25Bit.gguf".to_owned()],
            file_specs: vec![DownloadFileSpec {
                repo_id: "Tencent-Hunyuan/Hy-MT2-1.8B-1.25bit-GGUF".to_owned(),
                file: "Hy-MT2-1.8B-1.25Bit.gguf".to_owned(),
                dest: "Hy-MT2-1.8B-1.25Bit.gguf".to_owned(),
            }],
            size_text: "~440 MB".to_owned(),
            kind: "translation".to_owned(),
            ocr_variant: None,
            recommended: false,
        },
        DownloadableModel {
            id: "hy-mt2-7b-q4".to_owned(),
            name: "Hy-MT2 7B Q4_K_M".to_owned(),
            description: "7B 多语言翻译核心，性能超越 DeepSeek/Kimi，ModelScope: Tencent-Hunyuan/Hy-MT2-7B-GGUF".to_owned(),
            repo_id: "Tencent-Hunyuan/Hy-MT2-7B-GGUF".to_owned(),
            files: vec!["Hy-MT2-7B-Q4_K_M.gguf".to_owned()],
            file_specs: vec![DownloadFileSpec {
                repo_id: "Tencent-Hunyuan/Hy-MT2-7B-GGUF".to_owned(),
                file: "Hy-MT2-7B-Q4_K_M.gguf".to_owned(),
                dest: "Hy-MT2-7B-Q4_K_M.gguf".to_owned(),
            }],
            size_text: "~4.6 GB".to_owned(),
            kind: "translation".to_owned(),
            ocr_variant: None,
            recommended: false,
        },
        DownloadableModel {
            id: "hy-mt2-7b-q6k".to_owned(),
            name: "Hy-MT2 7B Q6_K".to_owned(),
            description: "7B 高精度量化，ModelScope: Tencent-Hunyuan/Hy-MT2-7B-GGUF".to_owned(),
            repo_id: "Tencent-Hunyuan/Hy-MT2-7B-GGUF".to_owned(),
            files: vec!["HY-MT2-7B-Q6_K.gguf".to_owned()],
            file_specs: vec![DownloadFileSpec {
                repo_id: "Tencent-Hunyuan/Hy-MT2-7B-GGUF".to_owned(),
                file: "HY-MT2-7B-Q6_K.gguf".to_owned(),
                dest: "HY-MT2-7B-Q6_K.gguf".to_owned(),
            }],
            size_text: "~6.2 GB".to_owned(),
            kind: "translation".to_owned(),
            ocr_variant: None,
            recommended: false,
        },
        DownloadableModel {
            id: "hy-mt2-7b-q8".to_owned(),
            name: "Hy-MT2 7B Q8_0".to_owned(),
            description: "7B 最高精度，ModelScope: Tencent-Hunyuan/Hy-MT2-7B-GGUF".to_owned(),
            repo_id: "Tencent-Hunyuan/Hy-MT2-7B-GGUF".to_owned(),
            files: vec!["HY-MT2-7B-Q8_0.gguf".to_owned()],
            file_specs: vec![DownloadFileSpec {
                repo_id: "Tencent-Hunyuan/Hy-MT2-7B-GGUF".to_owned(),
                file: "HY-MT2-7B-Q8_0.gguf".to_owned(),
                dest: "HY-MT2-7B-Q8_0.gguf".to_owned(),
            }],
            size_text: "~8.0 GB".to_owned(),
            kind: "translation".to_owned(),
            ocr_variant: None,
            recommended: false,
        },
